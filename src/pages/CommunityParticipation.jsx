...
const CommunityParticipation = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/communities/user/${userId}/challenges`)
      .then(res => {
  ...
  const handleJoin = () => {
    ...
    axios.post(`${process.env.REACT_APP_API_URL}/communities/user/${userId}/join-challenge`, {
